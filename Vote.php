...
<html lang="en">
    ...
    <body id="bodyCon">
        ...
        <div class="container" id="container" style="">
            ...
            <form action="vote_process.php" method="POST" style="width:100%">
                <table>
                    <tr>
                        <th>
                            <div id="header">What Do You Prefer Tommorow?</div>
                        </th>
                    </tr>
                    ...
                    <fieldset>
                        ...
                        <div class="option-group">
                            <?php
                            try {
                                $food_poll = \classes\Poll::getPoll($dbcon);
                                foreach ($food_poll as $std_poll) {
                                    ?>
                                    <tr>
                                        <td>
                                            <div class="form-check"  id="foodItem">

                                                <input class="form-check-input" type="radio" name="vote"  value="<?php echo $std_poll->getFood_name() ?>">
                                                <label> <?php echo $std_poll->getFood_name() ?> </label>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="submit" class="btn btn-secondary btn-order" value="Vote Now">
                            </td>
                        </tr> 
                        <?php
                        $message = null;
                        if (isset($_GET["message"])) {
                            ...
                            if ($status == 1) {
                                ...
                                <div class="alert alert-success" role="alert" style='font-size: 16px;'>
                                    Your Vote Has Been Sucessfully Added
                                </div>  
                                <?php
                            } else {
                                $message = "<h6 class='text-success' style='color: red; font-size: 16px;'>Error In Submitting Your Vote. Please Try Again.</h6>";
                            }
                        }
                        ?>
                </table>
                        ...
                        <div class="row gx-5">
                            <div class="col-lg-4 col-md-12 pt-5 mb-5">
                                ...
                                <div id="footerSubFont" class="d-flex mb-2">
                                    ...
                                    <p class="mb-0">flexuwu@gmail.com</p>
                                </div>
                                <div id="footerSubFont" class="d-flex mb-2">

...
<html lang="en">
    ...
    <body id="bodyCon">
        ...
        <div class="container mt-5" id="styleOfContents">
            <div class="row">
                <div class="col-md-6">
                    <img src="./AdminPanel/uploads/Asian-Noodles-PNG-File.jpg" alt="Product Image" class="img-fluid">
                </div>
                <div class="col-md-6 mt-5 pt-5">
                    <h1 style="color: wheat;">Product Name</h1>
                    <p>Price: $50.00</p>
                    <p class="py-4">Description of the product goes here. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    <label for="quantity">Quantity:</label>
                    <input type="number" id="quantity" name="quantity" class="form-control mb-2 quantity-input">
                    <button class="btn btn-outline-warning mt-5">Add to Cart</button>
                </div>
            </div>
        </div>

        ...
        <div class="container" id="container" style="">
            <form action="payment_processing.php" method="POST" style="width:100%">
                <table>
                    <tr>
                        <th>
                            <div id="header">Your Pre Order</div>
                        </th>
                    </tr>
<?php
            ...
            try {
                ...
                $query = "SELECT * FROM defaultfood WHERE food_id=?";
                $pstmt = $con->prepare($query);
                $pstmt->bindValue(1, $food_id);
                $pstmt->execute();
...
?>
                    ...
                    <fieldset>
                        <tr>
                            <td><div class="option-group">
                                    ...
                                    Selected Food: <font color="black"> <input type="text" name="food_name" value="<?php echo $rs->food_name; ?>"readonly></font>
                        </div>
                    </td>
                     <td><div class="option-group">
                             
                             Pickup Date: <font color="black"> <input type="date" name="pick_date">
                             </font>
                        </div>
                    </td>
                     <td><div class="option-group">
                            
                            Pickup Time:  <font color="black"> <input type="time" name="pick_time">
                          </font>
                        </div>
                    </td>
                        </tr> 
                    ...
                    <tr>
                        <td></td>
                         <td></td>
                        <td>
                            <input type="submit" class="btn btn-secondary btn-order" value="Place Pre Order">
                        </td>
                    </tr>

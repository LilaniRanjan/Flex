...
<html>
    <head>
        ...
        <title>Single User History</title>
    ...
    <div class="history">
        <div class="table-container">
            <h5>Single User History</h5>
            <h5 class="card-title">
                <div class="input-group">
                    <button type="button" class="btn" style="margin-left: 80%; border: 1px solid #E88F2A; color: #E88F2A; background-color: black;">Delete All History</button>
                </div>
            </h5>
            <table id="historyTable" class="table">
                ...
                <tbody class="text-center">
                    <tr>
                        ...
                        <td style="background-color: black; color: white;">2023.08.30</td>
                        <td style="background-color: black; color: white;">preorder</td>
                        <td style="background-color: black; color: white;">245.00</td>
                    </tr>
                    <tr>
                        <td style="background-color: black; color: white;">2</td>
                        <td style="background-color: black; color: white;">2023.08.25</td>
                        <td style="background-color: black; color: white;">cash payment</td>
                        <td style="background-color: black; color: white;">120.00</td>
                    </tr><br>
                </tbody>
            </table><br>
        </div>

                        ...
                        <div class="card-body">
                            <div class="card-body">
                                <div class="form-group my-2">
                                    ...
                                    <input style="background-color: black; color: white;" name="curry_name" type="text" id="curry_name" class="form-control" required/>  
                                </div>
                                <br>
                                <div class="form-group my-2">
                                    <label for="curry_price">Curry Price :</label>
                                    <input style="background-color: black; color: white;" name="curry_price" type="number" id="curry_price" class="form-control" required/>
                                </div>
                                <br>
                                <br>
                                <button type="submit" name="submit" class="mt-3 btn btn-lg btn-block form-control" style="background-color: #333; color: white; border: 1px solid #E88F2A;">ADD CURRY</button>
                            </div>
                        </div>
                    </div>
                </form>

...
try {
    ...
    echo "Error in AdminExtraIngredientManagment File Db Connection: " . $exc->getMessage();
}
?>
        ...
        <div class="grid-container">
            ...
            <div class="card m-5" id="tableEdit">
                <div class="card-header my-3 d-inline">
                    EXTRA INGREDIENT DETAILS MANAGEMENT
                </div>
                <hr>
                <div class="d-inline d-flex justify-content-end mx-3">
                    <a href="ExtraIngredientAddForm.php" data-toggle="modal" class="btn active" role="button" aria-pressed="true" style="background-color: black; color: wheat; border: 1px solid white;">ADD NEW</a>
                </div>
                        ...
                        <div class="charts my-4">
                            ...
                            <div class="charts-cardss table-responsive">
                                ...
                                <table class="table table-hover table-responsive-md">
                                    ...
                                    try {
                                        $i = 1;
                                        $rs = \classes\ExtraIngredients::GetExtraIngredientDetails($con);
                                        foreach ($rs as $extra) {
                                            ?>
                                            <tbody class="text-center">
                                                <tr>
                                                    ...
                                                    <td style="background-color: black; color: white;">
                                                        <?php
                                                        $extra_details = new \classes\ExtraIngredients($extra->getExtra_ingredients_name(), $extra->getExtra_ingredients_price());
                                                        $extra_id = $extra_details->getExtraIngredientIdByName($extra->getExtra_ingredients_name(), $con);

                                                        echo $extra_id;
                                                        ?>
                                                    </td>
                                                    <td style="background-color: black; color: white;"><?php echo $extra->getExtra_ingredients_name(); ?></td>
                                                    <td style="background-color: black; color: white;"><?php echo $extra->getExtra_ingredients_price(); ?></td>
                                                    <td style="background-color: black; color: white;"><a href="ExtraIngredientEdit.php?id=<?php echo $extra->getExtraIngredientIdByName($extra->getExtra_ingredients_name(), $con); ?>"><button id="iconColour" style="background-color: black;"><i class="fa fa-pencil-square" aria-hidden="true" style="color: #E88F2A;"></i></button></a></td>
                                                    <td style="background-color: black;color: white;"><a href="ExtraIngredientDelete.php?id=<?php echo $extra->getExtraIngredientIdByName($extra->getExtra_ingredients_name(), $con); ?>"><button id="iconColour" style="background-color: black;"><i class="fa fa-trash" aria-hidden="true" style="color: #E88F2A;"></i></button></a></td>
                                                </tr>
                                            </tbody>
                                            <?php
                                            $i++;

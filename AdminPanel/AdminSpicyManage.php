...
try {
    ...
    echo "Error in AdminSpicyManagment File Db Connection: " . $exc->getMessage();
}
?>
        ...
        <div class="grid-container">
            ...
            <div class="card m-5" id="tableEdit">
                ...
                <div class="d-inline d-flex justify-content-end mx-3">
                    <a href="SpicyAddForm.php" data-toggle="modal" class="btn active" role="button" aria-pressed="true" style="background-color: black; color: wheat; border: 1px solid white;">ADD NEW</a>
                </div>
                                ...
                                <table class="table table-hover table-responsive-md">
                                    <thead class="text-center py-2">
                                        <tr>
                                            ...
                                            <th style="background-color: #333; color: wheat;" scope="col" class="text-center">Spicy Level Id</th>
                                            <th style="background-color: #333; color: wheat;" scope="col">Spicy Level Name</th>
                                    ...
                                    try {
                                        $i = 1;
                                        $rs = classes\SpiceLevel::GetSpicyDetails($con);
                                        foreach ($rs as $spicy) {
                                            ?>
                                            <tbody class="text-center">
                                                <tr>
                                                    ...
                                                    <td style="background-color: black; color: white;">
                                                        <?php
                                                        $spicy_details = new \classes\SpiceLevel($spicy->getSpice_level());
                                                        $spicy_id = $spicy_details->GetSpiceLevelIdBySpiceLevelName($spicy->getSpice_level(), $con);

                                                        echo $spicy_id;
                                                        ?>
                                                    </td>
                                                    <td style="background-color: black; color: white;"><?php echo $spicy->getSpice_level(); ?></td>
                                                    <td style="background-color: black; color: white;"><a href="SpicyEdit.php?id=<?php echo $spicy->GetSpiceLevelIdBySpiceLevelName($spicy->getSpice_level(), $con); ?>"><button id="iconColour" style="background-color: black;"><i class="fa fa-pencil-square" aria-hidden="true" style="color: #E88F2A;"></i></button></a></td>
                                                    <td style="background-color: black;color: white;"><a href="SpicyDelete.php?id=<?php echo $spicy->GetSpiceLevelIdBySpiceLevelName($spicy->getSpice_level(), $con); ?>"><button id="iconColour" style="background-color: black;"><i class="fa fa-trash" aria-hidden="true" style="color: #E88F2A;"></i></button></a></td>
                                                </tr>
                                            </tbody>
                                            <?php
                                            $i++;

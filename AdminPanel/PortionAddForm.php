...
try {
    ...
    echo "Error in PortionAddForm File Db Connection: " . $exc->getMessage();
}
?>
            ...
            <main class="main-container">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                    <div id="cardStyle" class="card mx-auto shadow p-3 mb-5 rounded" style="width: 50%;">
                        <div class="card-header text-center"><h4 style="color: #E88F2A;">ADD NEW PORTION SIZE DETAILS</h4></div>
                        <hr>
                        <div class="card-body">
                            <div class="card-body">
                                <div class="form-group my-2">
                                    <label for="portion_size_name">Portion Size :</label>
                                    <input style="background-color: black; color: white;" name="portion_size_name" type="text" id="portion_size_name" class="form-control" required/>  
                                </div>
                                <br>
                                <br>
                                <br>
                                <button type="submit" name="submit" class="mt-3 btn btn-lg btn-block form-control" style="background-color: #333; color: white; border: 1px solid #E88F2A;">ADD PORTION SIZE</button>
                            </div>
                        </div>
                    </div>
                </form>

...
try {
    ...
    echo "Error in AdminPopularFoodManagment File Db Connection: " . $exc->getMessage();
}
?>
        ...
        <div class="grid-container">
            ...
            <div class="card m-5" id="tableEdit">
                <div class="card-header my-3 d-inline">
                    POPULAR FOOD DETAILS MANAGEMENT
                </div>
                <hr>
                                ...
                                <table class="table table-hover table-responsive-md">
                                    <thead class="text-center py-2">
                                        <tr>
                                            ...
                                            <th style="background-color: #333; color: wheat;" scope="col" class="text-center">User Feedback Id</th>
                                            <th style="background-color: #333; color: wheat;" scope="col">Feedback</th>
                                            <th style="background-color: #333; color: wheat;" scope="col">Visible Option</th>
                                    ...
                                    try {
                                        $i = 1;
                                        $rs = classes\UserFeedBack::getAllFeedBack($con);
                                        foreach ($rs as $feedback) {
                                            ?>
                                            <tbody class="text-center">
                                                <tr>
                                                    ...
                                                    <td style="background-color: black; color: white;">
                                                        <?php
                                                        $feedback_detail = new \classes\UserFeedBack($feedback->getUserId(), $feedback->getUser_feedback(), $feedback->getVisbility_option());
                                                        $feedback_id = $feedback_detail->getFeedbackIdByName($feedback->getUser_feedback(), $con);
                                                    ...
                                                    <td style="background-color: black; color: white;">
                                                        <?php 
                                                        echo $feedback->getUser_feedback();
                                                        ?>
                                                    </td>
                                                    <td style="background-color: black; color: white;"><?php echo $feedback->getVisbility_option(); ?></td>
                                                    <td style="background-color: black; color: white;"><?php echo $feedback->getUserId(); ?></td>
                                                    <td style="background-color: black; color: white;"><a href="UserFeedbackEdit.php?id=<?php echo $feedback_detail->getFeedbackIdByName($feedback->getUser_feedback(), $con); ?>"><button id="iconColour" style="background-color: black;"><i class="fa fa-pencil-square" aria-hidden="true" style="color: #E88F2A;"></i></button></a></td>
                                                </tr>
                                            </tbody>
                                            <?php
                                            $i++;

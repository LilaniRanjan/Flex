        ...
        <div class="grid-container">
            ...
            <div class="card m-5" id="tableEdit">
                ...
                <div class="d-inline d-flex justify-content-end mx-3">
                    <a href="PopularFoodAddForm.php" data-toggle="modal" class="btn active" role="button" aria-pressed="true" style="background-color: black; color: wheat; border: 1px solid white;">ADD NEW</a>
                </div>
                                ...
                                <table class="table table-hover table-responsive-md">
                                    <thead class="text-center py-2">
                                        <tr>
                                            ...
                                            <th style="background-color: #333; color: wheat;" scope="col" class="text-center">Popular Food Id</th>
                                            <th style="background-color: #333; color: wheat;" scope="col">Popular food image</th>
                                            <th style="background-color: #333; color: wheat;" scope="col">Food Name</th>
                                            <th style="background-color: #333; color: wheat;" scope="col">Default Price</th>
                                            <th style="background-color: #333; color: wheat;" scope="col">Current Price</th>
                                            <th style="background-color: #333; color: wheat;" scope="col">Vote Count</th>

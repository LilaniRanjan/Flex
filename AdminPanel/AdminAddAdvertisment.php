...
<?php
ob_start();
require '../classes/Advertisment.php';
            ...
            <main class="main-container">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
                    if (isset($_POST['event_name'])) {
                        ...
                        if(isset($_FILES) & !empty($_FILES)){
                            $name = $_FILES['advertismentimage']['name'];
                            $size = $_FILES['advertismentimage']['size'];
                            $type = $_FILES['advertismentimage']['type'];
                            $tmp_name = $_FILES['advertismentimage']['tmp_name'];
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                    <div id="cardStyle" class="card mx-auto shadow p-3 mb-5 rounded" style="width: 50%;">
                        <div class="card-header text-center"><h4 style="color: #E88F2A;">ADD NEW ADVERTISMENT DETAILS</h4></div>
                        <hr>
                        <div class="card-body">
                            <div class="card-body">
                                <div class="form-group my-2">
                                    <label for="event_name">Event Name :</label>
                                    <input style="background-color: black; color: white;" name="event_name" type="text" id="event_name" class="form-control" required/>  
                                </div>
                                <br>
                                <div class="form-group my-2">
                                    <label for="advertismentimage">Event Image</label>
                                    <input type="file" name="advertismentimage" id="advertismentimage">
                                    <p class="help-block">Only jpg/png are allowed.</p>
                                </div>
                                <br>
                                <br>
                                <button type="submit" name="submit" class="mt-3 btn btn-lg btn-block form-control" style="background-color: #333; color: white; border: 1px solid #E88F2A;">ADD ADVERTISMNET</button>
                            </div>
                        </div>
                    </div>
                </form>

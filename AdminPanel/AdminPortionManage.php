...
try {
    ...
    echo "Error in AdminPortionManagment File Db Connection: " . $exc->getMessage();
}
?>
        ...
        <div class="grid-container">
            ...
            <div class="card m-5" id="tableEdit">
                ...
                <div class="d-inline d-flex justify-content-end mx-3">
                    <a href="PortionAddForm.php" data-toggle="modal" class="btn active" role="button" aria-pressed="true" style="background-color: black; color: wheat; border: 1px solid white;">ADD NEW</a>
                </div>
                                ...
                                <table class="table table-hover table-responsive-md">
                                    <thead class="text-center py-2">
                                        <tr>
                                            ...
                                            <th style="background-color: #333; color: wheat;" scope="col" class="text-center">Portion Size Id</th>
                                            <th style="background-color: #333; color: wheat;" scope="col">Portion Size Name</th>
                                    ...
                                    try {
                                        $i = 1;
                                        $rs = \classes\PortionSize::GetPortionSizeDetails($con);
                                        foreach ($rs as $portion) {
                                            ?>
                                            <tbody class="text-center">
                                                <tr>
                                                    ...
                                                    <td style="background-color: black; color: white;">
                                                        <?php
                                                        $portion_details = new \classes\PortionSize($portion->getPortion_size_name());
                                                        $portion_id = $portion->getPortionIdByPortionName($portion->getPortion_size_name(), $con);

                                                        echo $portion_id;
                                                        ?>
                                                    </td>
                                                    <td style="background-color: black; color: white;"><?php echo $portion->getPortion_size_name(); ?></td>
                                                    <td style="background-color: black; color: white;"><a href="PortionEdit.php?id=<?php echo $portion->getPortionIdByPortionName($portion->getPortion_size_name(), $con); ?>"><button id="iconColour" style="background-color: black;"><i class="fa fa-pencil-square" aria-hidden="true" style="color: #E88F2A;"></i></button></a></td>
                                                    <td style="background-color: black;color: white;"><a href="PortionDelete.php?id=<?php echo $portion->getPortionIdByPortionName($portion->getPortion_size_name(), $con); ?>"><button id="iconColour" style="background-color: black;"><i class="fa fa-trash" aria-hidden="true" style="color: #E88F2A;"></i></button></a></td>
                                                </tr>
                                            </tbody>
                                            <?php
                                            $i++;

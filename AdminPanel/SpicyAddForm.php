...
try {
    ...
    echo "Error in SpicyAddForm File Db Connection: " . $exc->getMessage();
}
?>
            ...
            <main class="main-container">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
                    if (isset($_POST['spicy_level'])) {
                        ...
                        try {
                            $spicy_detail = new classes\SpiceLevel($spicy_level);
                            $spicy = $spicy_detail->addSpicyDetails($con);
                            if ($spicy) {
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                    <div id="cardStyle" class="card mx-auto shadow p-3 mb-5 rounded" style="width: 50%;">
                        <div class="card-header text-center"><h4 style="color: #E88F2A;">ADD NEW SPICY LEVEL DETAILS</h4></div>
                        <hr>
                        <div class="card-body">
                            <div class="card-body">
                                <div class="form-group my-2">
                                    <label for="spicy_level">SPICY LEVEL :</label>
                                    <input style="background-color: black; color: white;" name="spicy_level" type="text" id="spicy_level" class="form-control" required/>  
                                </div>
                                <br>
                                <br>
                                <br>
                                <button type="submit" name="submit" class="mt-3 btn btn-lg btn-block form-control" style="background-color: #333; color: white; border: 1px solid #E88F2A;">ADD SPICY LEVEL</button>
                            </div>
                        </div>
                    </div>
                </form>

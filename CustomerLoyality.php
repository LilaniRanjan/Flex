                        ...
                        try {
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    echo "<tr>";
                                    echo "<td style=\"background-color: black; color: white;\">{$row['user_id']}</td>";
                                    echo "<td style=\"background-color: black; color: white;\">{$row['first_name']}</td>";
                                    echo "</tr>";
                                }
                            } else {

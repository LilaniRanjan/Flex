...
<head>
    ...
    <style>
        /* Custom CSS styles for the success message */
        .container {
            text-align: center;
            padding-top: 20px;
        }
...
<body id="bodyCon">
    ...
    <div class="container">
        <div class="success-box">
            ...
            <p>Your payment has been successfully processed. <br> <br> Thank you for your order!</p>
        </div>
    </div>
        
        
        <!-- Footer Start -->
            <div class="container-fluid bg-img text-secondary bg-dark" style="margin-top: 150px; padding-bottom: 30 px;">
                <div class="container">
                    <div class="row gx-5">
